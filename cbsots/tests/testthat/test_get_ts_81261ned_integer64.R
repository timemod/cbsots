# This test job went wrong with old version of cbsots (<= 1.8.0), because the 
# data read with  command 'data <- fread(data_file, drop = "ID", integer64 = "numeric")'
# still contains an integer64 columns (argument integer64 apparantly did not
# work well)
library(cbsots)
library(testthat)
...
test_name <- paste0(id, "_integer64")
