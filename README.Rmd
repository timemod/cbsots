...
In this README file the Shiny App will be presentled briefly to give you
...
In the next figure the table for dimension "GoederenEnDiensten" (Goeds and Services)
is shown:
...
"Topic" and "GoederenEnDiensten". The names of the timeseries
...
For this ordering the the timeseries names would become `vic___`, `vic_go `, 
etc.
